...
export default function GatiPage() {
  ...
  function applyPayOnly() {
    ...
    // Ky buton është "Vetëm Pagesa" (pa dorëzim). Implementimi i pagesës ruhet në flow-n e DORËZIMIT.
    // Këtu e mbyllim vetëm nëse është futur një shumë pozitive.
    setShowPaySheet(false);
  }
      ...
      try {
        ...
        const cashRes = await recordCashMove({
          ...
          type: 'IN',
	          ...
	          createdBy: actor?.name || actor?.full_name || actor?.username || null,
        });
