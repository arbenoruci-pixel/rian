...
function pickEventTs(row, data, source = 'base') {
  // Dispatch/Marrje date safety:
  // updated_at is only a technical edit timestamp. It must never decide
  // whether an order belongs to Marrje/Dorzim for today, because cleanup,
  // recovery, or metadata repair jobs can update old orders and make them
  // appear as today's collections/payments.
  if (source === 'transport') {
    return (
