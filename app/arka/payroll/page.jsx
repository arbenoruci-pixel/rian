...
export default function PayrollPage() {
  ...
  async function reloadAll(isSilent = false) {
    ...
    try {
      ...
      const { data: rawDebts, error: debtErr } = await supabase
    ...
    <div className="payrollPage">
      <div className="shell">
        <div className="topbar">
          ...
          <div className="topActions">
            ...
            <Link href="/arka/stafi" className="navBtn primaryGhost">MENAXHIMI I STAFIT</Link>
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        @media (max-width: 640px) {
          ...
          .payBtn, .saveBtn, .greenCta, .amberCta {
            width: 100%;
          }
          .fullOverlay {
            padding: 8px;
