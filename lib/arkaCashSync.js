...
// ==============================
// COMPAT: CashClient expects this name
// ==============================
export async function processPendingPayments(openedBy = "LOCAL") {
  // flush any queued payments/moves safely
  return flushArkaQueue(openedBy);
}
