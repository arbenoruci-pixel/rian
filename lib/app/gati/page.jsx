...
export default function GatiPage() {
  ...
  async function confirmDelivery() {
    ...
    // Do this BEFORE we mark the order as delivered.
    if (willRecordCash && safeDelta > 0) {
      ...
      try {
        ...
        alert('❌ Pagesa nuk u regjistrua në ARKË. Provo prap (mos e mbyll porosinë).');
        return;
      }
    }
    ...
    try {
      ...
      alert('❌ Nuk u ruajt dorëzimi në databazë. Provo prap.');
      return;
    }

    // ✅ NOW we can remove from UI + save local mirror
