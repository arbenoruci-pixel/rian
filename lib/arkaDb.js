...
// Local YYYY-MM-DD (device timezone). Do NOT use toISOString().slice(0,10)
// because that is UTC and can shift the day around midnight.
...
export async function dbOpenDay({ initial_cash, opened_by, day_key }) {
  const key = String(day_key || dayKeyLocal());
