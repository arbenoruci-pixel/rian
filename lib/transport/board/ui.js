...
export const ui = {
  page: { width: '100%', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', backgroundColor: "#000000", minHeight: "100vh", color: "#FFFFFF", fontFamily: "-apple-system, BlinkMacSystemFont, Roboto, sans-serif", display: "flex", flexDirection: "column" },
  header: { minWidth: 0, maxWidth: '100%', boxSizing: 'border-box', padding: "16px 16px 0 16px", backgroundColor: "#000000", position: "sticky", top: 0, zIndex: 10 },
  ...
  tabsContainer: { display: "grid", gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', minWidth: 0, gap: 8, paddingBottom: 16, borderBottom: "1px solid #1C1C1E" },
  tab: { minWidth: 0, minHeight: 44, position: 'relative', overflowWrap: 'anywhere', backgroundColor: "#1C1C1E", color: "#FFF", border: "none", padding: "8px 6px", borderRadius: 20, fontSize: 14, fontWeight: "600", cursor: "pointer", textAlign: 'center' },
  tabActive: { minWidth: 0, minHeight: 44, position: 'relative', overflowWrap: 'anywhere', backgroundColor: "#8E44AD", color: "#FFF", border: "none", padding: "8px 6px", borderRadius: 20, fontSize: 14, fontWeight: "600", cursor: "pointer", textAlign: 'center' },
  badge: { backgroundColor: "#FFF", color: "#000", fontSize: 10, padding: "2px 6px", borderRadius: 10, fontWeight: "800" },
  dot: { position: 'absolute', top: 5, right: 5, width: 7, height: 7, borderRadius: 999, backgroundColor: "#FF3B30", display: "inline-block", boxShadow: "0 0 0 2px rgba(0,0,0,0.35)" },
