...
import { openTransportClientMap } from '../clientLocationMap.js';
...
export function getCode(row) {
  ...
  return String(row?.client_tcode || row?.data?.transport_client_tcode || row?.data?.client_tcode || row?.data?.client?.transport_client_tcode || row?.data?.client?.tcode || row?.data?.client?.code || row?.code_str || row?.data?.code_str || row?.data?.order_code || row?.data?.order_tcode || row?.data?.official_order_code || row?.order_code || row?.t_code || row?.data?.t_code || row?.code || "").trim();
}
...
export function openMap(row) {
  return openTransportClientMap(row);
}
