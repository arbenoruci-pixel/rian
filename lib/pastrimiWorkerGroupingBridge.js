...
function ensureStyle() {
  ...
  style.textContent = `
    ...
    #${TOOLBAR_ID} {
      position: fixed;
      /* Page filters stay below payment, packaging and rack dialogs. */
      z-index: 20;
    ...
    #root .list-item-compact[data-pastrimi-worker-group="fitim"] {
...
export function installPastrimiWorkerGroupingBridge() {
  ...
  try { window.__TEPIHA_PASTRIMI_WORKER_GROUPING__ = { version: 'v3-fitim-group', scheduleApply }; } catch {}
  scheduleApply();
}
