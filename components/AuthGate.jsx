...
export default function AuthGate({ children }) {
  ...
  if (!ready) {
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 18, background: "#0b0f14", color: "#e8eef6" }}>
        <div style={{ width: "100%", maxWidth: 520, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.03)", borderRadius: 14, padding: 18, textAlign: "center", fontWeight: 900, letterSpacing: "0.06em", textTransform: "uppercase", fontSize: 14 }}>
          DUKE U NGARKUAR...
        </div>
      </div>
    );
