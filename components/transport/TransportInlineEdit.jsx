...
export default function TransportInlineEdit({
  ...
  const codeRaw = normalizeTCode(item?.code_str || base?.code_str || base?.order_code || base?.order_tcode || base?.official_order_code || item?.order_code || item?.client_tcode || base?.client_tcode || base?.client?.tcode || base?.client?.code || item?.code || item?.codeRaw || '');
