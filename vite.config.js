...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        importScripts: ['/sw-navigation-diag.js?v=3514'],
  ...
  server: {
    ...
    proxy: {
      '/api': {
        ...
        // Preserve the browser-facing Host so same-origin CSRF checks in the
        // local Express API see the same authority as the Origin header.
        changeOrigin: false,
      },
    },
  },
