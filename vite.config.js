...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        importScripts: ['/sw-navigation-diag.js?v=3509'],
        ...
        runtimeCaching: [
          {
            ...
            options: {
              cacheName: 'tepiha-vite-business-routes-v44-query-authority-transport-guard-payment-button-v3',
          ...
          },
          {
            ...
            options: {
              cacheName: 'tepiha-vite-static-assets-v44-query-authority-transport-guard-payment-button-v3',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
          ...
          },
          {
            ...
            handler: 'CacheFirst',
            options: {
              cacheName: 'tepiha-vite-media-v44-query-authority-transport-guard-payment-button-v3',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
