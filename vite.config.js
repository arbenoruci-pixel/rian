      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          },
          {
            ...
            options: {
              cacheName: 'tepiha-vite-static-assets-v46-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1-pastrimi-payment-touch-v3-unified-arka-payroll-v1-repeat-visit-v2-pastrimi-payment-fast-close-v4-arka-daily-expense-step-v1-home-search-localoid-dedupe-v1-arka-daily-operations-v3-arka-salary-only-handoff-v1',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
          ...
          },
          {
            ...
            handler: 'CacheFirst',
            options: {
              cacheName: 'tepiha-vite-media-v46-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1-pastrimi-payment-touch-v3-unified-arka-payroll-v1-repeat-visit-v2-pastrimi-payment-fast-close-v4-arka-daily-expense-step-v1-home-search-localoid-dedupe-v1-arka-daily-operations-v3-arka-salary-only-handoff-v1',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
