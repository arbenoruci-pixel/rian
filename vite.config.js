...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        importScripts: ['/sw-navigation-diag.js?v=3511'],
        ...
        runtimeCaching: [
          {
            ...
            options: {
              cacheName: 'tepiha-vite-business-routes-v44-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1',
          ...
          },
          {
            ...
            options: {
              cacheName: 'tepiha-vite-static-assets-v44-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
          ...
          },
          {
            ...
            handler: 'CacheFirst',
            options: {
              cacheName: 'tepiha-vite-media-v44-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1',
              cacheableResponse: {
                statuses: [0, 200],
              },
              expiration: {
