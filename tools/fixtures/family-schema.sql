...
create table orders(id bigint primary key,client_id uuid,code bigint,client_name text,client_phone text,status text,data jsonb default '{}',total numeric,paid numeric,price_total numeric,paid_cash numeric,m2_total numeric,pieces integer,created_at timestamptz default now(),updated_at timestamptz default now(),ready_at timestamptz,picked_up_at timestamptz,delivered_at timestamptz);
