...
createRoot(document.getElementById('root')).render(<BrowserRouter><Routes><Route path="/k/:id" element={<TrackingPage/>}/><Route path="*" element={<Staff/>}/></Routes></BrowserRouter>);
