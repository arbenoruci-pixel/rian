...
function patchBuildIdentity() {
  ...
  sw = sw
    ...
    .replace(/const APP_VERSION = '[^']+';/, `const APP_VERSION = '2.0.129-arka-expense-submit-v1-dispatch-timeout-reconcile-v1-legacy-bridge';`)
    .replace(/const SW_BUILD_LABEL = '[^']+';/, `const SW_BUILD_LABEL = 'sw-pwa-auto-update-v4-arka-expense-submit-v1-dispatch-timeout-reconcile-v1-legacy-bridge';`);
