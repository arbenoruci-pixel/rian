...
pkg.scripts['test:gati-payment-fast-receipt-v1'] = 'node tools/verify-gati-payment-fast-receipt-v1.mjs && node tools/verify-gati-offline-queue-first-v1.mjs && node tools/verify-ready-notifications-v1.mjs && node tools/verify-ready-notification-quota-v3.mjs && node tools/verify-base-ready-dispatch-flow-v1.mjs';
