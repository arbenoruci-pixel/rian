...
check(String(pkg.version || '').includes('gati-rack-save-v1'), 'package build version missing GATI rack suffix');
check(vite.includes('gati-rack-save-v1'), 'PWA cache generation was not bumped');
check(vite.includes('sw-navigation-diag.js?v=3511'), 'service-worker import generation was not bumped');
