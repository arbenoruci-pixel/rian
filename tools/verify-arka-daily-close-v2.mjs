...
check(vite.includes('v44-query-authority-transport-guard-payment-button-v3-arka-daily-close-v2-home-search-base-role-v1-gati-rack-save-v1'), 'PWA cache generation not bumped compatibly');
if (hasRackFinalOwner) {
