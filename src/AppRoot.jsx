...
import GlobalHomeSearch from '@/components/GlobalHomeSearch.jsx';
import MainSwipeNavigation from '@/components/MainSwipeNavigation.jsx';
...
// OPERATIONAL_FULLSCREEN_V2_COMPONENT
    ...
    <BrowserRouter>
      ...
      <GlobalErrorBoundary>
        <AuthGate>
          ...
          <LocalErrorBoundary name="GlobalHomeSearch" source="app_root_global_home_search" sourceLayer="app_root_global_home_search">
            <GlobalHomeSearch />
          </LocalErrorBoundary>

          <LocalErrorBoundary name="MainSwipeNavigation" source="app_root_main_swipe_navigation" sourceLayer="app_root_main_swipe_navigation">
            <MainSwipeNavigation />
          </LocalErrorBoundary>
